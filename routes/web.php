...
Route::post('/fuel/fill', [FuelFillController::class, 'store'])
    ...
    ->name('fuel');
// عرض تفاصيل السيارة
Route::get('/fuels/{fuel}', [FuelFillController::class, 'showfuel'])
->name('fuel.show');
// تقرير التعبئة لكل سيارة
Route::get('/fuels/{fuel}/fuel-report', [FuelFillController::class, 'fuelReport'])
->name('fuel.report');
// تقرير شامل لكل السيارات (اختياري)
Route::get('/reports', [FuelFillController::class, 'allReports'])
->name('reports.index');
